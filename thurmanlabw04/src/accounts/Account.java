 ...
 * Uses an int for the account number and the owner's Id, doubles for the balance and apy, 
 * a boolean for overdraft protection, and an ArrayList of Integers to hold user Ids of users with access to the account.
 * Assignment: labW04
 * @author Seth Thurman
 * @version 1.0
 * 
...
@Override
  public String toString() {
     return String.format("Account{number= '%d', balance='%.2f', APY='%.2f', Overdraft Protection='%b', Owner ID='%d', User IDs= '%s' }", this.number, this.balance, this.apy, this.overdraftProtect, this.ownerID, this.userIDs.toString());
