...
/**
 * A {@code employeeCredential} object extends the Credential class and represents a employee's credentials.
 * The fields for this class are the mostly same as Credential, except for the addition of an int authorization code, so {@see security.Credential}. 
 * 
 * Assignment: labW04
 * @author Seth Thurman
 * @version 1.0
 * 
 */
public class EmployeeCredential extends Credential implements Cloneable{
 ...
 */
  ...
  public String toString() {
    return String.format("EmployeeCredential{username= '%s', password='%s', pin= '%d' , authCode= '%d' }", super.getUsername(), super.getPassword(), super.getPin(), this.authCode);
  }
