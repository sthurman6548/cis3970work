...
/**
 * An {@code Associate} class extends the Employee class and represents an associate employee
 ...
 */
public Associate( int id, String fName, String lName, String email, String uname, String password, int pin, String title) {
...
@Override
  public String toString() { 
    return String.format("Associate={profile='%s', credential='%s', title='%s'}", this.getProfile().toString(), this.getCredential().toString(), this.getTitle());
  }
