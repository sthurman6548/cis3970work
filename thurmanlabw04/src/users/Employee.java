...
/**
 * A {@code Employee} object extends the User class and represents the bank employees.
 * It has the same fields as a User so {@see users.User}, however it also adds a String for the title;
 * 
 * Assignment: labW04
 * @author Seth Thurman
 * @version 1.0
 ...
 */
  public Employee( int id, String fName, String lName, String uname, String email, String password, int pin, String title) {
  ...
  public String toString() { 
    return String.format("Employee={profile='%s', credential'%s', title='%s'}", this.getProfile().toString(), this.getCredential().toString());
  }
