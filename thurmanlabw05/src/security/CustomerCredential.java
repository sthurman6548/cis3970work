...
/**
 * A {@code CustomerCredential} object extends the Credential class and
 * represents a customer's credentials.
 * The fields for this class are the same as Credential so
 * {@see security.Credential}.
 * 
 * Assignment: labW04
 * 
 * @author Seth Thurman
...
public class CustomerCredential extends Credential implements Cloneable {
  ...
  public String toString() {
    ...
    return String.format("CustomerCredential[username= '%s', password='%s', pin= '%d' ]", super.getUsername(),
        super.getPassword(), super.getPassword());
  }
