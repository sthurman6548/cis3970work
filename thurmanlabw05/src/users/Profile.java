 ...
 * The fields for this class are all Strings for the first name, last name, and
 * email address.
 * 
 * Assignment: labW04
 * 
...
public class Profile implements Cloneable, Comparator<Profile> {
  ...
  public String toString() {
    return String.format("Profile[id='%d', firstName='%s', lastName='%s', emailAddr='%s']", this.id, this.firstName,
        this.lastName, this.emailAddr);
  }
